...
Then there is that good old Keynesian thing[[3]](https://en.wikipedia.org/wiki/Keynesian_economics#Keynesian_economic_policies). Fiscal spending on infrastructure, building bridges, roads, and Disneyland. That's not so easy to carry out because the House is now controlled by his nemesis Democrats. And rumor is they don't like more Disneylands.
...
[4] That's the Troubled Asset Relief Program (TARP). According to this [wiki entry](https://en.wikipedia.org/wiki/Troubled_Asset_Relief_Program), Fed spent a total of $21.0 billion on these toxic assets.
